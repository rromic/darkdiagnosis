...
http://krijesnica.hr/donacije (for international donations)`,
    ...
    },
    {
        ...
        description: `The condition known as auto-brewery syndrome is a rare medical condition in which ethanol is produced by carbohydrate fermentation in the gastrointestinal tract. Although a person did not or does not consume alcohol, ingested sugars are converted to ethanol in the patient's gut. Saccharomyces cervisiae is a yeast isolated in the GI system, most often causing the gut fermentation syndrome. The quantity of produced alcohol is high enough to cause symptoms which can be the same as someone that has been consuming alcohol. Auto-brewery syndrome is successfully treated by avoiding carbohydrate-rich food, antifungal therapy and probiotics.`,
    ...
    },
    {
        id: 'Scleroderma',
        name: 'Scleroderma',
        description: `Scleroderma is an autoimmune multi-system disease characterized by fibrosis of the skin, and possible fibrosis of internal organs in addition to vasculopathy. Scleroderma can be classified into skin localized types and systemic sclerosis; with involment of renal, interstitial lung, diffuse gastrointestinal, and myocardial disease. One of the early symptoms that requires monitoring is Raynaud's phenomenon. in which spasm of arteries causes episodes of discoloration in fingers and toes, after changes in temperature or emotions. It is often an indicator of the future onset of systemic scleroderma. Another symptom can be the significant impairment in the mimicry of the face which thus gives the appearence of a mask. The sunflower is the international symbol for scleroderma as the sunflower turns towards the sun for warmth, smilar to people with scleroderma who usually achieve remission of symptoms in warmer weather.
...
More about Scleroderma on our recent post: https://www.instagram.com/p/B0ZIxudBbmp/?igshid=18255r0utyhvz`,
    ...
    },
    {
        ...
        description: `Asperger syndrome was first described in 1944 when Hans Asperger, an Austrian doctor described four children with “a lack of empathy, little ability to form friendships, one-sided conversation, intense absorption in one particular interest and clumsy movements.” They were each passionately interested in one narrow subject and would talk endlessly about one specific interest. Asperger called them “little professors” because of their ability to talk about their favourite subject in great detail. According to the DSM-5, Asperger syndrome is classified under the single umbrella term of autism spectrum disorder, which includes autism, Asperger syndrome and pervasive developmental disorders. Patients with Asperger's have impaired interaction and nonverbal communication with others, a limited understanding of other’s feelings,  in addition to restricted and repetitive patterns of behavior and interests. Most commonly, persons with Asperger's  have an average level of intelligence if not, even above average levels. It is important to identify Asperger syndrome as early as possible and start with multi-disciplinary treatment. Ignorance of Asperger syndrome can lead to failure in engagement with others socially, depression (especially by adolescents), stress, mood disorders and chronic frustration.
...
Coronaviruses are named for their crown-like spikes on the surface of the virus that attach and enter host cells. 

They appear to have originated in animals, however in some cases, can be transmitted to humans thus causing diseases with fatal respiratory conditions (SARS, MERS, COVID-19 infection). The first case of COVID-19 has been linked to a seafood market in Wuhan, China.

Today the virus is being spread mainly from person to person contact. It is believed that the virus (twice as contagious as the seasonal flu) is transmitted by droplets either directly (by inhaling respiratory droplets) or indirectly (by touching contaminated surfaces where the virus can survive for several hours or even days). People are most contagious when they are sickest, however it is also possible to spread the virus without having symptoms, known as an ASYMPTOMATIC period.
...
There is currently (16th April, 2020) no vaccine nor specific and targed drug treatments available. Management consists of supportive care.

Depending on individual country’s healthcare system and capacities, mortality rate from COVID19  currently varies about 3,4%, estimated by WHO (3/3/2020).  In order to decrease the number of cases and slow down the epidemic thus allowing healthcare systems to fight against the virus, it is strongly recommended to decrease and/or stop all unnecessary physical and social contact. Please read and follow the guidelines available below. 

If you suspect having COVID19, please DO NOT visit your doctor, hospital or local emergency room. Instead, call 113 or visit the website: http://koronavirus.hr/
